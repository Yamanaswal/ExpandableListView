...
public class CustomExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public CustomExpandableAdapter(Context context, List<String> expandableListTitle,
        ...
        this.expandableListTitle = expandableListTitle; //parent
        this.expandableListDetail = expandableListDetail; //child
    }

    @Override
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        String listTitle = String.valueOf(getGroup(groupPosition));
        if (convertView == null) {
